...
public class Bank {
	 ...
	 * @param name  the name of the banks
	 */
	...
	public User addUser(String firstName, String lastName, String pin) {
		...
		//create a savings account for the user and add to User and Bank Account
	 ...
	 * @return        the User object, if the login is succesful, or null if it is not
	 */
